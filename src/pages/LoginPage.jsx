...
/* ─────────────────────────────────────────────────
   PR-02  feat/auth-email
   • Email + password form wired to Supabase
   • Google OAuth wired to Supabase
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-violet-950 to-slate-900 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-8 shadow-2xl">
          ...
          {serverError && (
            <div className="flex items-start gap-2.5 bg-red-500/10 border border-red-500/30 rounded-xl p-3.5 mb-5 text-sm text-red-300">
              <svg width="16" height="16" className="mt-0.5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
        ...
        <p className="text-center text-xs text-slate-600 mt-5">
          © {new Date().getFullYear()} Hope, Inc. · New Era University — BS Information Technology
        </p>
      </div>
    </div>
  )
